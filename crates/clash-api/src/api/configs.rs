...
impl Client {
    ...
    /// Backward-compatible alias retained for core-manager callers.
...
mod tests {
    ...
    #[test]
    fn providing_tun_patch_sends_enable_flag() {
    ...
    #[test]
    fn runtime_config_optional_tunnel_configs_are_backward_compatible() {
